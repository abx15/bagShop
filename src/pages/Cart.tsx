...
const Cart = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen pt-24 pb-16 bg-background flex flex-col items-center justify-center text-center px-4 w-full">
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              {cart.map((item) => (
                <div
                  ...
                  className="p-6 flex flex-col sm:flex-row gap-6 border-b border-border last:border-0 relative group w-full"
                >
                  {/* Image */}
                  <Link
                    to={`/products/${item.id}`}
